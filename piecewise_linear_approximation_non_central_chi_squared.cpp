...
#include "piecewise_linear_approximation_non_central_chi_squared_coefficients.hpp"
...
#pragma omp declare simd
static inline void interpolation_indices(const float32 y, uint32 * __restrict__ interpolation_index_lower, uint32 * __restrict__ interpolation_index_upper, float32 * __restrict__ weight_lower, float32 * __restrict__ weight_upper)
{
